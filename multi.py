...
class RTopo(Topo):
 ...
 # Can test upload and download
        ...
        ##2
        self.addLink(h3, r2, intfName1 = f'h3-eth', intfName2 = f'r2-eth1', params2 = {'ip' : '10.0.3.1/24'}, bw=10)
        self.addLink(h4, r2, intfName1 = f'h4-eth', intfName2 = f'r2-eth2', params2 = {'ip' : '10.0.4.1/24'}, bw=10)
        #R3
        self.addLink(h5, r3, intfName1 = f'h5-eth', intfName2 = f'r3-eth1', params2 = {'ip' : '10.0.5.1/24'}, bw=10)
        self.addLink(h6, r3, intfName1 = f'h6-eth', intfName2 = f'r3-eth2', params2 = {'ip' : '10.0.6.1/24'}, bw=10)


 # connect bottleneck link to router
 # Bottleneck link to internet
        self.addLink(r1,r2, intfName1 = 'r1-eth3', intfName2 = 'r2-eth3', params1={'ip': '10.100.0.1/24'}, params2={'ip': '10.100.0.2/24'})
        self.addLink(r1,r3, intfName1 = 'r1-eth4', intfName2 = 'r3-eth3', params1={'ip': '10.101.0.1/24'}, params2={'ip': '10.101.0.2/24'})
        self.addLink(r2,r3, intfName1 = 'r2-eth4', intfName2 = 'r3-eth4', params1={'ip': '10.102.0.1/24'}, params2={'ip': '10.102.0.2/24'})
...
def main():
    ...
    r1.cmd('ip route add 10.0.3.0/24 via 10.100.0.2 dev r1-eth3')
    r1.cmd('ip route add 10.0.4.0/24 via 10.100.0.2 dev r1-eth3')
    r1.cmd('ip route add 10.0.5.0/24 via 10.101.0.2 dev r1-eth4')
    r1.cmd('ip route add 10.0.6.0/24 via 10.101.0.2 dev r1-eth4')

    r2.cmd('ip route list')
    r2.cmd('ifconfig r2-eth1 10.0.3.1/24')
    r2.cmd('ifconfig r2-eth2 10.0.4.1/24')
    r2.cmd('ip route add 10.0.1.0/24 via 10.100.0.1 dev r2-eth3')
    r2.cmd('ip route add 10.0.2.0/24 via 10.100.0.1 dev r2-eth3')
    r2.cmd('ip route add 10.0.5.0/24 via 10.102.0.2 dev r2-eth4')
    r2.cmd('ip route add 10.0.6.0/24 via 10.102.0.2 dev r2-eth4')

    r3.cmd('ip route list')
    r3.cmd('ifconfig r3-eth1 10.0.5.1/24')
    r3.cmd('ifconfig r3-eth2 10.0.6.1/24')
    r3.cmd('ip route add 10.0.1.0/24 via 10.101.0.1 dev r3-eth3')
    r3.cmd('ip route add 10.0.2.0/24 via 10.101.0.1 dev r3-eth3')
    r3.cmd('ip route add 10.0.3.0/24 via 10.102.0.1 dev r3-eth4')
    r3.cmd('ip route add 10.0.4.0/24 via 10.102.0.1 dev r3-eth4')
    ...
    for h in [r1, r2, r3, h1, h2, h3, h4, h5, h6]: h.cmd('/usr/sbin/sshd')
